	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI DATA WARGA PERUMAHAN CIKARANG UTAMA RESIDENCE 2</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/login.jpg" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text"> CUR 2 CIKARANG</span>
			</a>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				...
				<a target="_blank" href="">
					<strong> AGUS SETIAWAN </strong>
				</a>
				All rights reserved.
			</div>
			<b>AYAH DINDA VERSI 2024</b>
		</footer>
